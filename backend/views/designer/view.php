...
$this->title = Yii::t('models', 'Designer');
$this->params['breadcrumbs'][] = ['label' => Yii::t('models', 'Designers'), 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => (string)$model->name, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = 'View';
?>
<div class="giiant-crud designer-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'Designer'=>$copyParams],
    ...
    <?php $this->beginBlock('common\models\Designer'); ?>
...
<div style='position:absolute; right: 0px; top: 0px;'>
  ...
  <?= Html::a(
            ...
            ['product/create', 'Product' => ['designer_id' => $model->id]],
...
<?=
 ...
 [
    ...
    'urlCreator' => function ($action, $model, $key, $index) {
        ...
        $params['Product'] = ['designer_id' => $model->primaryKey()[0]];
        return $params;
    },
    'buttons'    => [
...
<?php $this->endBlock() ?>
 ...
 [
    ...
    'content' => $this->blocks['common\models\Designer'],
    'active'  => true,
],
[
